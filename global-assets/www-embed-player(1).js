...
jf("//web.archive.org/web/20191003170001/https://static.doubleclick.net/instream/ad_status.js",a);vf.push(rf(function(){wf||"google_ad_status"in window||(pf("//web.archive.org/web/20191003170001/https://static.doubleclick.net/instream/ad_status.js",a),wf=!0,N("DCLKSTAT",3))},5E3))}}
...
b=Ce("//web.archive.org/web/20191003170001/https://googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof vd&&b.abort();
return sd(c)})}
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();O("PL_ATT")&&Cf.dispose();a=0;for(var b=vf.length;a<b;a++)uf(vf[a]);vf.length=0;of("//web.archive.org/web/20191003170001/https://static.doubleclick.net/instream/ad_status.js");wf=!1;N("DCLKSTAT",0);Vc(Zi,Yi);if(a=Xi)a.removeEventListener("onScreenChanged",bj),a.removeEventListener("onLogClientVeCreated",aj),a.removeEventListener("onLogServerVeCreated",cj),a.removeEventListener("onLogVeClicked",dj),a.removeEventListener("onLogVesShown",ej),a.destroy();$i={}});
...
/*
     FILE ARCHIVED ON 17:00:01 Oct 03, 2019 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  captures_list: 131.46
  exclusion.robots: 0.119
  exclusion.robots.policy: 0.11
  RedisCDXSource: 2.799
  esindex: 0.007
  LoadShardBlock: 101.986 (3)
  PetaboxLoader3.datanode: 118.3 (5)
  CDXLines.iter: 17.044 (3)
  load_resource: 1312.399 (2)
  PetaboxLoader3.resolve: 820.129 (2)
*/