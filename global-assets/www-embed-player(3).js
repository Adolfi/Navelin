...
jf("//web.archive.org/web/20191103020857/https://static.doubleclick.net/instream/ad_status.js",a);uf.push(rf(function(){vf||"google_ad_status"in window||(pf("//web.archive.org/web/20191103020857/https://static.doubleclick.net/instream/ad_status.js",a),vf=!0,N("DCLKSTAT",3))},5E3))}}
...
b=Ce("//web.archive.org/web/20191103020857/https://googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof vd&&b.abort();
return sd(c)})}
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();O("PL_ATT")&&Bf.dispose();a=0;for(var b=uf.length;a<b;a++){var c=uf[a];if(!isNaN(c)){var d=y("yt.scheduler.instance.cancelJob");d?d(c):S(c)}}uf.length=0;of("//web.archive.org/web/20191103020857/https://static.doubleclick.net/instream/ad_status.js");vf=!1;N("DCLKSTAT",0);Uc($i,Zi);if(a=Yi)a.removeEventListener("onScreenChanged",cj),a.removeEventListener("onLogClientVeCreated",bj),a.removeEventListener("onLogServerVeCreated",dj),a.removeEventListener("onLogVeClicked",ej),a.removeEventListener("onLogVesShown",
fj),a.destroy();aj={}});
...
/*
     FILE ARCHIVED ON 02:08:57 Nov 03, 2019 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  captures_list: 165.997
  exclusion.robots: 0.1
  exclusion.robots.policy: 0.092
  RedisCDXSource: 0.508
  esindex: 0.008
  LoadShardBlock: 45.579 (3)
  PetaboxLoader3.datanode: 82.72 (5)
  CDXLines.iter: 34.166 (3)
  load_resource: 196.803 (2)
  PetaboxLoader3.resolve: 123.484 (2)
*/