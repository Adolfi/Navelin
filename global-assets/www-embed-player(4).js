...
jf("//web.archive.org/web/20191030025614/https://static.doubleclick.net/instream/ad_status.js",a);uf.push(rf(function(){vf||"google_ad_status"in window||(pf("//web.archive.org/web/20191030025614/https://static.doubleclick.net/instream/ad_status.js",a),vf=!0,N("DCLKSTAT",3))},5E3))}}
...
b=Ce("//web.archive.org/web/20191030025614/https://googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof vd&&b.abort();
return sd(c)})}
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();O("PL_ATT")&&Bf.dispose();a=0;for(var b=uf.length;a<b;a++){var c=uf[a];if(!isNaN(c)){var d=y("yt.scheduler.instance.cancelJob");d?d(c):S(c)}}uf.length=0;of("//web.archive.org/web/20191030025614/https://static.doubleclick.net/instream/ad_status.js");vf=!1;N("DCLKSTAT",0);Uc($i,Zi);if(a=Yi)a.removeEventListener("onScreenChanged",cj),a.removeEventListener("onLogClientVeCreated",bj),a.removeEventListener("onLogServerVeCreated",dj),a.removeEventListener("onLogVeClicked",ej),a.removeEventListener("onLogVesShown",
fj),a.destroy();aj={}});
...
/*
     FILE ARCHIVED ON 02:56:14 Oct 30, 2019 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  load_resource: 211.19 (2)
  captures_list: 98.628
  esindex: 0.029
  RedisCDXSource: 0.854
  PetaboxLoader3.datanode: 112.753 (5)
  PetaboxLoader3.resolve: 89.917 (2)
  CDXLines.iter: 19.046 (3)
  LoadShardBlock: 49.142 (3)
