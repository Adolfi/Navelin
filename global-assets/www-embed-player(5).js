...
jf("//web.archive.org/web/20191031040305/https://static.doubleclick.net/instream/ad_status.js",a);uf.push(rf(function(){vf||"google_ad_status"in window||(pf("//web.archive.org/web/20191031040305/https://static.doubleclick.net/instream/ad_status.js",a),vf=!0,N("DCLKSTAT",3))},5E3))}}
...
b=Ce("//web.archive.org/web/20191031040305/https://googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof vd&&b.abort();
return sd(c)})}
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();O("PL_ATT")&&Bf.dispose();a=0;for(var b=uf.length;a<b;a++){var c=uf[a];if(!isNaN(c)){var d=y("yt.scheduler.instance.cancelJob");d?d(c):S(c)}}uf.length=0;of("//web.archive.org/web/20191031040305/https://static.doubleclick.net/instream/ad_status.js");vf=!1;N("DCLKSTAT",0);Uc($i,Zi);if(a=Yi)a.removeEventListener("onScreenChanged",cj),a.removeEventListener("onLogClientVeCreated",bj),a.removeEventListener("onLogServerVeCreated",dj),a.removeEventListener("onLogVeClicked",ej),a.removeEventListener("onLogVesShown",
fj),a.destroy();aj={}});
...
/*
     FILE ARCHIVED ON 04:03:05 Oct 31, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 05:47:06 May 24, 2021.
...
/*
playback timings (ms):
  captures_list: 271.789
  exclusion.robots: 0.081
  exclusion.robots.policy: 0.073
  RedisCDXSource: 2.13
  esindex: 0.007
  LoadShardBlock: 240.783 (3)
  PetaboxLoader3.datanode: 159.145 (5)
  CDXLines.iter: 15.447 (3)
  PetaboxLoader3.resolve: 153.55 (3)
  load_resource: 126.899 (2)
*/