...
sf("//web.archive.org/web/20190201120619/https://static.doubleclick.net/instream/ad_status.js",a);Ef.push(Af(function(){Ff||"google_ad_status"in window||(yf("//web.archive.org/web/20190201120619/https://static.doubleclick.net/instream/ad_status.js",a),Ff=!0,P("DCLKSTAT",3))},5E3))}}
...
b=Le("//web.archive.org/web/20190201120619/https://googleads.g.doubleclick.net/pagead/id",a)}),function(a){a instanceof Hd&&b.abort();
return Ed(a)})}
...
;function Ci(a){if("1"!==cb(me(),"args","privembed")){a&&ne();try{Bi().then(function(a){a=qe(a);a.bsq=Di++;Re("//web.archive.org/web/20190201120619/https://www.youtube.com/ad_data_204",{va:!1,B:a,withCredentials:!0})},function(){}),T(Ci,18E5)}catch(b){R(b)}}}
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&Kf.dispose();a=0;for(var b=Ef.length;a<b;a++)Df(Ef[a]);Ef.length=0;xf("//web.archive.org/web/20190201120619/https://static.doubleclick.net/instream/ad_status.js");Ff=!1;P("DCLKSTAT",0);fd(Ki,Ji);if(a=Ii)a.removeEventListener("onScreenChanged",Ni),a.removeEventListener("onLogClientVeCreated",Mi),a.removeEventListener("onLogServerVeCreated",Oi),a.removeEventListener("onLogVeClicked",Pi),a.removeEventListener("onLogVesShown",Qi),a.removeEventListener("onReady",Ri),a.destroy();Li=
{}});
...
/*
     FILE ARCHIVED ON 12:06:19 Feb 01, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 05:52:35 May 24, 2021.
...
/*
playback timings (ms):
  captures_list: 428.155
  exclusion.robots: 0.185
  exclusion.robots.policy: 0.172
  RedisCDXSource: 5.678
  esindex: 0.025
  LoadShardBlock: 237.781 (3)
  PetaboxLoader3.datanode: 434.588 (4)
  CDXLines.iter: 63.691 (3)
  load_resource: 272.896
  PetaboxLoader3.resolve: 59.917
*/